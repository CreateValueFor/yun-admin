...
const serviceNameFormatter = (service) => {
    switch (service) {
        ...
        case '[윤식단] 샐러드 정기 배달 - 1일1식10일 프로그램(2주)':
            return '1일 1식 10일 프로그램'
        case '[윤식단] 샐러드 정기 배송 - 1일 1식 4일 프로그램':
            return '1일 1식 4일 프로그램'
        case '[윤식단] 샐러드 정기 배송 - 1일 2식 4일 프로그램':
            return '1일 2식 4일 프로그램'
        case '[윤식단] 샐러드 정기 배송 - 1일 3식 4일 프로그램':
            return '1일 3식 4일 프로그램'
